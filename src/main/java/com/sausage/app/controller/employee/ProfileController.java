...
import com.sausage.app.domain.profile.profileAddress.ProfileAddressGetResponse;
import com.sausage.app.domain.profile.profileAddress.ProfileAddressPostRequest;
import com.sausage.app.domain.profile.profileAddress.ProfileAddressPostResponse;
import com.sausage.app.domain.profile.profileContact.ProfileContact;
import com.sausage.app.domain.profile.profileContact.ProfileContactGetResponse;
import com.sausage.app.domain.profile.profileContact.ProfileContactPostRequest;
import com.sausage.app.domain.profile.profileContact.ProfileContactPostResponse;
import com.sausage.app.domain.profile.profileDocument.ProfileDocumentGetResponse;
import com.sausage.app.domain.profile.profileDocument.ProfileDocumentPostRequest;
import com.sausage.app.domain.profile.profileDocument.ProfileDocumentPostResponse;
import com.sausage.app.domain.profile.profileEmergencyContact.ProfileEmergencyContact;
import com.sausage.app.domain.profile.profileEmergencyContact.ProfileEmergencyContactGetResponse;
import com.sausage.app.domain.profile.profileEmergencyContact.ProfileEmergencyContactPostRequest;
import com.sausage.app.domain.profile.profileEmergencyContact.ProfileEmergencyContactPostResponse;
import com.sausage.app.domain.profile.profileEmployment.ProfileEmployment;
import com.sausage.app.domain.profile.profileEmployment.ProfileEmploymentGetResponse;
import com.sausage.app.domain.profile.profileEmployment.ProfileEmploymentPostRequest;
import com.sausage.app.domain.profile.profileEmployment.ProfileEmploymentPostResponse;
import com.sausage.app.domain.profile.profileName.ProfileName;
import com.sausage.app.domain.profile.profileName.ProfileNameGetResponse;
import com.sausage.app.domain.profile.profileName.ProfileNamePostRequest;
import com.sausage.app.domain.profile.profileName.ProfileNamePostResponse;
import com.sausage.app.service.profile.*;
