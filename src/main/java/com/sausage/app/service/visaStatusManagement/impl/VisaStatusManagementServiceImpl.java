...
@Service
public class VisaStatusManagementServiceImpl implements VisaStatusManagementService {
    ...
    public void setVisaStatusManagement(int userId, File file) {
        Employee employee = getEmployeeByUserId(userId);
        ApplicationWorkFlow applicationWorkFlow = applicationWorkFlowDAO.getApplicationWorkFlowByEmployee(employee);
        String filePath = String.format(Constant.APPLICATION_WORK_FLOW_PATH, employee.getId(), applicationWorkFlow.getStatus());
